...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WorkDay>().Property(w => w.Mark).HasColumnType("decimal(18,4)");
        modelBuilder.Entity<Expense>().Property(e => e.Amount).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<ContaPessoal>().Property(c => c.ValorPrevisto).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<ContaPessoal>().Property(c => c.ValorPago).HasColumnType("decimal(18,2)");
        modelBuilder.Entity<Tarefa>().Property(t => t.HorasGastas).HasColumnType("decimal(18,2)");
